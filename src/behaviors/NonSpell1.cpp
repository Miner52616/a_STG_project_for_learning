...
NonSpell1_1::NonSpell1_1(Entity* entity,Resource* resource,YellowPage* yellowpage):
    Behavior(resource,yellowpage),entity_(entity),shoot_clock_(2),bulletconfig_(resource->app_.red_light_bulletTexture_)
{
...
NonSpell1_2::NonSpell1_2(Entity* entity,Resource* resource,YellowPage* yellowpage):
    Behavior(resource,yellowpage),entity_(entity),shoot_clock_(72),bulletconfig_(resource->app_.red_light_bulletTexture_)
{
    bulletnum_=90;
    bullet_direction_={0,1};
    initial();
