...
## 简介
一个使用 **C++ 和 SFML** 编写的简单项目，阶段目标是完成STG游戏系统基本内容的构建，同时在现有基础上继续完善STG游戏的基本框架

**已完成STG游戏基本框架搭建：**
完成页面的基本框架，支持多级页面切换。
完成游戏页面的基本操作。
完成包括脚本式道中、状态驱动多阶段Boss战、空白阶段和结束在内的游戏的基本流程。
完成包括碰撞检测，模块化敌人、Boss、阶段创建等内容创作的前提条件。
完成包括分数统计，残机数量等部分游戏系统。


**近期任务：**

1 继续添加STG游戏的游戏系统至游戏性最小完成的程度

2 完善overlays类的演出系统。加入特效系统。加入少量演出与部分特效

3 完善UI的动效系统。为现有UI添加简单动效

......

此外，后续将继续完善菜单和游戏页面的框架。
...
使用 g++ 手动编译（示例）（项目经常变动懒得再改这里了（最后更新于2026.2），实际请把所有.cpp文件加入编译命令即可（或者使用项目中的task.json编译））：
